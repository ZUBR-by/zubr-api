...
class Report
{
    ...
    {
        return $this->numberVotersFromObserver !== null
            || $this->numberVotersFromProtocol !== null
            || $this->votersReceivedBallotsCount !== null
            || $this->upfrontVotersCount !== null
            || $this->homeVotersCount !== null
            || $this->commissionVotersCount !== null
            || $this->droppedOutVotersCount !== null
            || $this->ballotsCount !== null
            || $this->filledBallotsCount !== null
            || $this->damagedBallotsCount !== null
            || $this->unusedBallotsCount !== null
            || $this->votesCountDmitriev !== null
            || $this->votesCountKonopatskaya !== null
            || $this->votesCountLukashenko !== null
            || $this->votesCountTihanovskaya !== null
            || $this->votesCountCherechen !== null
            || $this->votesCountAgainstAll !== null;
    }

    public function mergeAttachments(array $old) : array
    {
        $result = [];
        $tmp    = array_merge($this->attachments, $old);
        foreach ($tmp as $item) {
            if (isset($result[$item['url']])) {
                continue;
            }
